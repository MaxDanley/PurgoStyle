    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900">
              Arizona activewear. <span className="text-cyan-600">Purgo</span> Style.
            </h1>
            <p className="mt-6 text-lg text-slate-700">
              <strong>Purgo</strong> comes from the Latin <em>purgō</em>—to purify, to make clean. 
              We’re an Arizona-based brand built on that idea: simple, honest gear you can rely on. 
            ...
            <p className="mt-4 text-lg text-slate-700">
              ...
              Quality fabrics, straightforward design, no fluff. That’s Purgo Style.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/products"
                className="inline-flex items-center rounded-lg bg-cyan-600 px-6 py-3 text-white font-medium hover:bg-cyan-700"
              >
                Shop Now
              </Link>
              <Link
      ...
      <section className="py-16 bg-slate-50">
        <div className="container-custom">
          <h2 className="text-2xl font-bold text-slate-900 mb-8">Why Purgo</h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h3 className="font-semibold text-slate-900 mb-2">Purify</h3>
              <p className="text-slate-600 text-sm">Latin <em>purgō</em>—to purify. We keep things clean: design, quality, and how we do business.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
