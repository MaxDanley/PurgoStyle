...
const faqData: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer: "We offer a 30-day return policy for unworn items with tags attached. Items must be in original condition. Contact hello@summersteez.com to start a return."
  },
  {
