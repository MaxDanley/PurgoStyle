  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Payment Instructions - Venmo (appears first if Venmo payment) */}
        {order.paymentMethod === "VENMO" && (
          <div className="mb-8 relative">
            {/* Glowing outline effect */}
            <div className="absolute -inset-2 rounded-lg blur-md opacity-60" style={{ backgroundColor: '#008CFF', boxShadow: '0 0 20px rgba(0, 140, 255, 0.5)' }}></div>
            <div className="relative bg-white rounded-lg shadow-lg border-2 p-6" style={{ borderColor: '#008CFF' }}>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Complete Your Venmo Payment</h3>
              
              <div className="space-y-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  <p className="text-sm text-yellow-800 font-medium mb-2 flex items-center gap-2">
                    <ExclamationTriangleIcon className="h-5 w-5 flex-shrink-0" />
                    <span>Important: Your order will not be processed until funds have cleared in our Venmo account.</span>
                  </p>
                </div>

                <div className="text-center py-2 mb-4">
                  <p className="text-sm text-gray-600 mb-1">Send payment of</p>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                  <div className="text-center">
                    <p className="text-xs font-medium text-gray-600 mb-3">Scan this QR code in your Venmo app:</p>
                    <div className="flex justify-center mb-4">
                      <Image
                        src="/venmo_qr_code.png"
                        alt="Venmo QR Code"
                        width={160}
                        height={160}
                    ...
                    <a 
                      href={`https://venmo.com/purgolabs?txn=pay&amount=${order.total.toFixed(2)}&note=Online+Goods`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-block bg-[#008CFF] text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#0074D4] transition-colors"
                    >
                      Pay with Venmo
                    </a>
                  </div>
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center justify-between bg-white border border-gray-300 rounded-lg p-3 mb-2">
                      <div>
                        <p className="text-xs text-gray-500 mb-1">Venmo Profile</p>
                        <code className="text-sm font-mono font-bold" style={{ color: '#008CFF' }}>@purgolabs</code>
                      </div>
                      <button
                        type="button"
                        onClick={() => {
                          navigator.clipboard.writeText("@purgolabs");
                        ...
                        style={{ backgroundColor: '#008CFF', color: 'white' }}
                        onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0074D4'}
                        onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#008CFF'}
                      >
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-xs font-medium text-yellow-900 mb-2">Note (Required):</p>
                  <div className="flex items-center justify-between bg-white border border-yellow-300 rounded-lg p-3 mb-2">
                    <code className="text-sm font-mono text-gray-900">Online Goods</code>
                    <button
                      type="button"
                      onClick={() => {
                        navigator.clipboard.writeText("Online Goods");
        ...
        {/* Payment Instructions - Zelle (appears first if Zelle payment) */}
        {order.paymentMethod === "ZELLE" && (
          <div className="mb-8 relative">
            {/* Glowing outline effect */}
            <div className="absolute -inset-2 rounded-lg blur-md opacity-60" style={{ backgroundColor: '#3aaff9', boxShadow: '0 0 20px rgba(58, 175, 249, 0.5)' }}></div>
            <div className="relative bg-white rounded-lg shadow-lg border-2 p-6" style={{ borderColor: '#3aaff9' }}>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Complete Your Zelle Payment</h3>
              
              <div className="space-y-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  <p className="text-sm text-yellow-800 font-medium mb-2 flex items-center gap-2">
                    <ExclamationTriangleIcon className="h-5 w-5 flex-shrink-0" />
                    <span>Important: Your order will not be processed until funds have cleared in our Zelle/Bank account.</span>
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                  <div className="text-center">
                    <p className="text-xs font-medium text-gray-600 mb-3">Scan this QR code in your banking app:</p>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between bg-white border border-gray-300 rounded-lg p-3">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-xs flex items-center gap-1 rounded-lg font-semibold transition-colors"
                        style={{ backgroundColor: '#3aaff9', color: 'white' }}
                        onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#2a9fe9'}
                        onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#3aaff9'}
                      >
                        <ClipboardIcon className="h-3 w-3" />
                        Copy
                      </button>
        ...
        {/* Payment Instructions - Crypto (appears first if Crypto payment) */}
        {order.paymentMethod === "CRYPTO" && order.cryptoPaymentAddress && (
          <div className="mb-8 relative">
            {/* Glowing outline effect */}
            <div className="absolute -inset-2 rounded-lg blur-md opacity-60" style={{ backgroundColor: '#3aaff9', boxShadow: '0 0 20px rgba(58, 175, 249, 0.5)' }}></div>
            <div className="relative bg-white rounded-lg shadow-lg border-2 p-6" style={{ borderColor: '#3aaff9' }}>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Complete Your Crypto Payment</h3>
              
              <div className="space-y-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  <p className="text-sm text-yellow-800 font-medium mb-2 flex items-center gap-2">
                    <ExclamationTriangleIcon className="h-5 w-5 flex-shrink-0" />
                    <span>Important: Your order will not be processed until payment is received and confirmed.</span>
                  </p>
                </div>
                ...
                <div className="text-center py-2 mb-4">
                  ...
                  <p className="text-xl font-bold text-gray-900">
                    {order.cryptoPaymentAmount ? (typeof order.cryptoPaymentAmount === 'number' ? order.cryptoPaymentAmount.toFixed(8) : order.cryptoPaymentAmount) : '0.00000000'} {order.cryptoCurrency?.toUpperCase() || ''}
                  </p>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        if (order.cryptoPaymentAddress) {
                          navigator.clipboard.writeText(order.cryptoPaymentAddress);
                  ...
                  <div className="bg-white border border-gray-300 rounded-lg p-3 break-all">
                    <code className="text-xs font-mono font-bold italic" style={{ color: '#3aaff9' }}>
                      {order.cryptoPaymentAddress}
                    </code>
                  </div>
                </div>
                ...
                {order.cryptoPaymentId && (
                  <div className="flex items-center gap-3 pt-2">
                    <button
                      type="button"
                      onClick={async () => {
                        if (!order.cryptoPaymentId) return;
                        ...
                        try {
                          ...
                          if (data.success && data.payment) {
                            ...
                            if (data.payment.paymentStatus === "finished" || data.payment.paymentStatus === "confirmed") {
                              ...
                              toast.success(`Payment status: ${data.payment.paymentStatus}`);
                            }
                          } else {
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        <span className={`${
                          paymentStatus === "finished" || paymentStatus === "confirmed"
                            ...
                            : paymentStatus === "waiting" || paymentStatus === "confirming" || paymentStatus === "pending"
                            ? "text-yellow-600"
