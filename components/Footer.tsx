    ...
    <footer className="bg-gray-50 text-gray-600 border-t border-gray-200">
      <div className="container-custom py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <Image src="/STEEZ.png" alt="PurgoLabs SummerSteeze" width={40} height={40} />
              <div>
                <div className="font-bold text-lg text-gray-900 leading-tight">PurgoLabs<br />SummerSteeze</div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/custom-design" className="text-gray-400 hover:text-brand-400 transition-colors">
          ...
          <div className="col-span-2 md:col-span-1 mt-6 md:mt-0">
            ...
            <a
              ...
              aria-label="PurgoLabs SummerSteeze on Facebook"
            >
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} PurgoLabs SummerSteeze. Arizona activewear and premium tees.
        </div>
      </div>
    </footer>
  );
