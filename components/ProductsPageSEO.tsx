...
export default function ProductsPageSEO() {
  return (
    <div className="container-custom py-12 max-w-4xl">
      <Accordion title="Browse by Research Category">
        <div className="prose prose-lg max-w-none text-gray-700">
          <h3 className="text-xl font-bold text-gray-900 mb-3">Receptor Agonists</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Hormone Analogs</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Growth Factor Compounds</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Antioxidant Compounds</h3>
          <p className="mb-4">
      ...
      <Accordion title="Research Applications Guide">
        <div className="prose prose-lg max-w-none text-gray-700">
          <h3 className="text-xl font-bold text-gray-900 mb-3">Tissue Repair Research</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Metabolic Studies</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Hormone Research</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Cellular Signaling</h3>
          <p className="mb-4">
      ...
      <Accordion title="Our Quality Assurance Process">
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">COA Availability</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Batch Tracking</h3>
          <p className="mb-4">
      ...
      <Accordion title="Research Resources & Support">
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Storage Guidelines</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Reconstitution Instructions</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Safety Data Sheets</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Research Methodology Guides</h3>
          <p className="mb-4">
      ...
      <Accordion title="Product Selection FAQ">
        <div className="prose prose-lg max-w-none text-gray-700">
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">How do I choose the right research peptide?</h3>
            <p className="text-gray-700">
              Selecting the appropriate research peptide depends on your specific research objectives, experimental system, and research questions. Consider factors such as target receptors, research applications, and compatibility with your experimental protocols. Review product descriptions, research areas, and technical specifications to identify compounds that align with your research needs.
            </p>
          </div>
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">What size should I order?</h3>
            <p className="text-gray-700">
              Product size selection depends on your research scale, experimental duration, and usage frequency. Consider ordering sufficient quantity to complete your research while maintaining proper storage conditions. Larger sizes may offer better value for long-term research projects.
            </p>
          </div>
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Can I combine multiple peptides in research?</h3>
            <p className="text-gray-700">
              Researchers often combine multiple peptides to investigate complex biological processes or synergistic effects. When combining peptides, consider compatibility, concentration interactions, and experimental design. Consult research literature and optimize protocols for multi-peptide applications.
            </p>
          </div>
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">What documentation comes with products?</h3>
            <p className="text-gray-700">
              All products include a Certificate of Analysis (COA) documenting purity, identity, and analytical testing results. Additional documentation may include storage instructions, reconstitution protocols, and safety information. Contact support for specific documentation requests.
            </p>
          </div>
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">How do I store multiple products?</h3>
            <p className="text-gray-700">
              Store all research peptides according to their specific storage requirements, typically at 2-8°C for short-term or -20°C for long-term storage. Organize storage to prevent cross-contamination and maintain proper labeling. Follow storage guidelines for each product to ensure stability.
            </p>
          </div>
        </div>
      </Accordion>
