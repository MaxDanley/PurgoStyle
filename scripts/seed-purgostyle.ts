/**
 * Seed PurgoLabs SummerSteeze store with t-shirt and activewear products.
...
const PRODUCTS: { name: string; slug: string; description: string; category: string; image: string; price: number }[] = [
  ...
  { name: "PurgoLabs SummerSteeze Classic Tee", slug: "purgo-classic-tee", description: "Signature PurgoLabs SummerSteeze tee.", category: "Tees", image: "/placeholder.svg", price: 59.99 },
  ...
  { name: "PurgoLabs SummerSteeze Premium Hoodie", slug: "purgo-premium-hoodie", description: "Premium heavyweight hoodie.", category: "Hoodies", image: "/placeholder.svg", price: 104.99 },
