-- Two orders for 2/12/26 — match peptide order refs; totals and items are PurgoLabs SummerSteeze website items.
...
-- Run once. Ensure PurgoLabs SummerSteeze products exist (run seed-purgo-products.sql or seed-purgo-labs first).
